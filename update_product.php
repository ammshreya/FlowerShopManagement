...
<section class="update-product">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <select name="category" class="box" required>
         ...
         <option value="main dish">fresh flowers</option>
         <option value="fast food">bouqeuts</option>
         <option value="drinks">cards</option>
         <option value="desserts">today's deal</option>
      </select>
